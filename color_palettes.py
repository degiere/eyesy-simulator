# Palette table from the Critter & Guitari EYESY OS.
#   https://github.com/critterandguitari/EYESY_OS
#   engines/python/color_palettes.py
# Copyright Critter & Guitari, BSD 3-Clause. See LICENSE-EYESY_OS.txt.
#
# Vendored verbatim so a color rendered here matches the hardware exactly.
# Do not edit — re-copy from upstream if the palettes change.
